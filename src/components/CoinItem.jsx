...
const CoinItem = ({coins}) => {
    return (
        <div className='text-gray-200 bg-slate-800 max-w-[1250px] flex items-center justify-between shadow-lg rounded-lg lg:mx-4 my-8 py-3 px-6 hover:scale-105 transition-all duration-300 cursor-pointer'>
